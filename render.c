...
/**
 * render - Renders the vector position and initializes its state
 * @state: Initialization pointer
 * @player: Vector's pointer
 * Return: Nothing
*/
...
void render(State *state, Player *player)
{
	...
	ColorRGBA RGBA_Orange = {.r = 0xFF, .g = 0xA5, .b = 0x00, .a = 0xFF};
	ColorRGBA RGBA_White = {.r = 0xFF, .g = 0xFF, .b = 0xFF, .a = 0xFF};
	ColorRGBA RGBA_Grey = {.r = 0x80, .g = 0x80, .b = 0x80, .a = 0xFF};
